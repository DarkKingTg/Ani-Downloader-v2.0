...
- � **Live Progress (1s refresh)**: Active downloads update once per second with speed, ETA, current file and downloaded size
...
The **Download** page and **Dashboard** show active downloads with:

- **Progress** (job-level, episode-based)
- **Speed** (based on file size growth during download)
- **ETA** (episode-based estimate)
- **Current file** and **downloaded size**

These UI widgets update **once per second** using SocketIO events with a polling fallback.
