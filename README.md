...
🎉 **Major Update**: Ani-Downloader now supports **1000+ websites** through our new plugin system!

### Key Highlights
- 🔌 **Plugin System**: Download from any website (YouTube, Crunchyroll, Funimation, etc.)
- 🛠️ **Helper Library**: Easy plugin development with `ani_plugin_helper.py`
- 📚 **Complete Documentation**: Tutorials and guides for plugin development
- 🔄 **Universal Support**: One app for all your anime downloading needs
...
Ani-Downloader now supports a powerful plugin system that allows downloading from any website supported by yt-dlp (1000+ sites including YouTube, Crunchyroll, Funimation, and more).

### Built-in Plugins
- **AnimeKai**: Original anikai.to support
- **yt-dlp Generic**: Universal support for any yt-dlp compatible site
- **GogoAnime**: Example plugin for gogoanime.is

### Plugin Development
Create your own plugins to support additional anime websites:
...
### Helper Library
The `ani_plugin_helper.py` library provides:
- **AnimeSiteHelper**: Common anime website patterns
- **YtDlpHelper**: yt-dlp integration utilities
...
- 🔄 **[Update Guide](UPDATE_GUIDE.md)**: How to update from GitHub releases
...
├── ani_plugin_helper.py   # Plugin development helper library
├── PLUGIN_DEVELOPMENT_TUTORIAL.md  # Plugin development guide
├── UPDATE_GUIDE.md        # Application update instructions
...
│   ├── anikai.py         # AnimeKai plugin
│   ├── ytdlp_generic.py  # Generic yt-dlp plugin
│   ├── gogoanime.py      # GogoAnime example plugin
...
- **ani_plugin_helper.py** - Plugin development utilities (included)
...
- 🔌 **Plugin Development**: Create plugins for new anime websites
- 📖 **Documentation**: Improve tutorials and guides
- 🧪 **Testing**: Test on different platforms and websites

### Plugin Contributions
- Follow the [Plugin Development Tutorial](PLUGIN_DEVELOPMENT_TUTORIAL.md)
- Use the helper library for consistency
- Test your plugin thoroughly
- Include documentation and examples
- Submit via Pull Request to the `plugins/` directory
...
- **Original Author**: [@Cinichi](https://github.com/Cinichi) - [Ani-Downloader](https://github.com/Cinichi/Ani-Downloader)
- **Current Maintainer**: [@DarkKingTg](https://github.com/DarkKingTg) - Plugin system, helper library, and recent updates
- Built with Flask and Python
- Uses yt-dlp for reliable video downloads
- Powered by anikai.to anime streaming service
- Plugin system inspired by Cloth Config for Minecraft Fabric
